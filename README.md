<table>
	...
	<tr>
		<td>
			<ol>
				<li>Создайте свой форк репозитория и склонируйте его.</li>
				<li>Исправьте/дополните файл у себя.</li>
				<li>Сделайте commit и push вашей копии в форк на GitHub.</li>
				<li>Пришлите Pull-запрос, я добавлю ваши изменения.</li>
...
|[Geopattern](http://btmills.github.io/geopattern/)|:uk:|Randomly generated patterns.|
